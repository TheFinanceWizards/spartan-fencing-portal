...
export const TESTIMONIALS = [
  { name: "Marcus Rivera", company: "Rivera Fence & Iron LLC", quote: "Spartan is our go-to supplier. The material quality is consistent, pricing is competitive, and they always have what we need in stock. That reliability is worth its weight in gold.", rating: 5 },
  { name: "Sarah Chen", company: "Pacific Coast Properties", quote: "We switched to Spartan for our multi-site commercial project and the difference was night and day. One phone call, one invoice, everything delivered on schedule.", rating: 5 },
  { name: "David Thompson", company: "Thompson General Contracting", quote: "Their custom fabrication shop saved us on a project with non-standard gate requirements. Turnaround was fast and the quality exceeded our client's expectations.", rating: 5 }
];
